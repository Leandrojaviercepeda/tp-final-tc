...
def main(tamanio_individuo, tamanio_poblacion, generaciones, porcentaje_mutacion, porcentaje_cruza ,pressure, corridas):
	soluciones = []
...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(prog='Input parser for Approx', description='Minimum vertex cover approximation')
	...
	main(TAMANIO_POBLACION, TAMANIO_INDIVIDUO, GENERACIONES, PRESSURE, PORCENTAJE_MUTACION, PORCENTAJE_CRUZA, CORRIDAS)